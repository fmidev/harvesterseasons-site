...
function plotSW() {
    ...
    var dataUrlSWI = "https://smdev.harvesterseasons.com/timeseries?latlon=" + latlonPoint + "&param=" + paramSWI + "&starttime=" + dateString_swi + "T000000Z&timesteps=1&format=json&precision=full";
    // var dataUrlSWI = "https://smdev.harvesterseasons.com/timeseries?latlon=" + latlonPoint + "&param=SWI1:SWI&starttime=" + dateString_swi + "T000000Z&timesteps=1&format=json&precision=full";
    $.getJSON(dataUrlSWI, function (dataSWI) {
