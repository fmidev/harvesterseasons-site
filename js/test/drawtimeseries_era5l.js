    ...
    $.getJSON(dataUrlSW, function (dataSW) {
        ...
        if (smartmetIdx == -1) {
            ...
            for (let i = 0; i < dataSW.length; i++) {
                ...
                dataSWscaled[i]["SWVL2-M3M3:SMARTMET:5015"] = dataSW[i]["SWVL2-M3M3:SMARTMET:5015"];
            ...
            $.getJSON(dataUrl2, function (data2) {
                ...
                for (k = 0; k < dataSWscaled.length; k++) {
                    if (dataSWscaled[k]["SWVL2-M3M3:SMARTMET:5015"] !== null
                        || dataSWscaled[k][SWensemblelist[0]] == null) {
                        summer1series[k] = 'nan';
                        ...
                        for (i = 0; i <= perturbations; i++) {
                            let value = dataSWscaled[k][SWensemblelist[i]];
                            if (isNaN(value)) { nans++ }
