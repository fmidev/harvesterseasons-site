...
// var startDate = new Date(Date.UTC(startYear, startMonth-1, 2));
// var startDate = new Date(Date.UTC(startYear, startMonth-2, 2));
...
// var dateString = startYear + '-' + startMonth + '-02/P7M';
...
// var dateString2 = startDate_timeseries.getUTCFullYear().toString() + '-' + startMonth_timeseries + '-02/P7M';
...
const param5 = "HARVIDX{4;SWVL2-M3M3:SMARTMET:5015}";
...
// // Latest SWI observation
var startDate_swi = new Date();
if (startDate_swi.getUTCHours() >= 4) {
    startDate_swi.setDate(startDate_swi.getUTCDate() - 10);
} else {
    startDate_swi.setDate(startDate_swi.getUTCDate() - 11);
}
var startMonth_swi = startDate_swi.getUTCMonth() + 1;
if (startMonth_swi < 10) {
    startMonth_swi = '0' + startMonth_swi;
}
var dateString_swi = startDate_swi.getUTCFullYear().toString() + startMonth_swi + startDate_swi.getUTCDate();
// console.debug(dateString_swi)

// console.debug(startDate_swi)
...
var devWMS = 'https://smdev.harvesterseasons.com/wms?';
...
var soilwetnessLayer = L.tileLayer.wms(devWMS, soilwetnessLayerOptions);
var soilwetnessTimeLayer = L.timeDimension.layer.wms(soilwetnessLayer, {cache: 100});
...
// var ndvidateString = startYear + '-' + startMonth + '-' + startDay + 'T00:00:00Z/P10D';
// var ndviTimeLayer = L.timeDimension.layer.wms(ndviLayer, {cache: 10, timeInterval: ndvidateString});
...
soilwetLegend.onAdd = function (map) {
    ...
    var src = 'https://smdev.harvesterseasons.com/wms?REQUEST=GetLegendGraphic&VERSION=1.3.0&LAYER=gui:SWI-SWI1&sld_version=1.1.0&style=&FORMAT=image/png&width=150&height=160';
    var div = L.DomUtil.create('div', 'info legend');
    // if (screen.width < 425) {
    //     // div.style.width = '65px';
    //     // div.style.height = '325px';
