...
/* 
// Tol bright colormap
const colorFrost = [68, 119, 170];
const colorNormalMineral = [102, 204, 238];
const colorDryMineral = [34, 136, 51];
const colorNormalPeat = [204, 187, 68];
const colorDryPeat = [238, 102, 119];
const colorWinter = [170, 51, 119]; 
*/

/* 
// Tol vibrant colormap
const colorFrost = [0, 119, 187];
const colorNormalMineral = [51, 187, 238];
const colorDryMineral = [0, 153, 136];
const colorNormalPeat = [238, 119, 51];
const colorDryPeat = [204, 51, 17];
const colorWinter = [238, 51, 119]; 
*/

/* 
// Tol muted colormap
const colorFrost = [51, 34, 136]; // indigo
const colorNormalMineral = [136, 204, 238]; // cyan
const colorNormalMineral = [68, 170, 153]; // teal
const colorDryMineral = [17, 119, 51]; // green
const colorNormalPeat = [153, 153, 51]; // olive
const colorDryPeat = [221, 204, 119]; // sand
*/

/* 
// Tol muted colormap v2
const colorFrost = [51, 34, 136]; // indigo
const colorNormalMineral = [68, 170, 153]; // teal
const colorDryMineral = [17, 119, 51]; // green
const colorNormalPeat = [153, 153, 51]; // olive
const colorDryPeat = [221, 204, 119]; // sand
const colorWinter = [136, 34, 85];  // wine
*/

/* 
// Tol muted colormap v3
const colorFrost = [51, 34, 136]; // indigo
const colorNormalMineral = [136, 204, 238]; // cyan
const colorDryMineral = [17, 119, 51]; // green
const colorNormalPeat = [153, 153, 51]; // olive
...
/* 
// Tol muted colormap v4
const colorFrost = [51, 34, 136]; // indigo
const colorNormalMineral = [68, 170, 153]; // teal
const colorDryMineral = [17, 119, 51]; // green
const colorNormalPeat = [153, 153, 51]; // olive
const colorDryPeat = [221, 204, 119]; // sand
const colorWinter = [170, 68, 153]; // purple
*/

/* 
// Tol muted colormap v5
const colorFrost = [51, 34, 136]; // indigo
const colorNormalMineral = [68, 170, 153]; // teal
const colorDryMineral = [17, 119, 51]; // green
const colorNormalPeat = [221, 204, 119]; // sand
const colorDryPeat = [204, 102, 119]; // rose
const colorWinter = [170, 68, 153]; // purple 
*/


/* 
// Tol muted colormap v6
const colorFrost = [51, 34, 136]; // indigo
const colorNormalMineral = [136, 204, 238]; // cyan
const colorDryMineral = [17, 119, 51]; // green
const colorNormalPeat = [153, 153, 51]; // olive
...
const colorNormalMineral = [110, 166, 205];
const colorDryMineral = [194, 228, 239];
...
/* 
// Tol sunset colormap v2
const colorFrost = [54, 75, 154];
const colorNormalMineral = [74, 123, 183];
const colorDryMineral = [110, 166, 205];
const colorNormalPeat = [246, 126, 75];
const colorDryPeat = [221, 61, 45];
const colorWinter = [165, 0, 38]; 
 */
...
const colorNormalMineral = [74, 123, 183];
const colorDryMineral = [110, 166, 205];
const colorNormalPeat = [253, 179, 102];
const colorDryPeat = [246, 126, 75];
const colorWinter = [165, 0, 38]; 
 */
                ...
                var pixelValuesToColorFn = values => {
                    if (values.some(value => value === noDataValue)) {
                        ...
                        if (r < 7) {
                            ...
                            // return `rgba(${colorMap[r][0]},${colorMap[r][1]},${colorMap[r][2]},${geotifftransparency})`;
